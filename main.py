    ...
    for timestep in range(1500):
        ...
        if timestep % update_rate == 0:
            ...
            for obs_index in range(no_of_observers):
                ...
                # Update destinations
                observer[obs_index].destination = observer_destinations[obs_index].position
